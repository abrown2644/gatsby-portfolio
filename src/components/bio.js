            ...
            <div className={styles.container}>
             ...
             <div className={styles.bioButtons}>
                 <ul>
                     ...
                     <li id={styles.linkThree} ><a href="../images/andrewbrown_resume.pdf" download><FontAwesomeIcon icon={faArrowDown} size="3x" className={styles.bioIcon} title={"Download Resume"} alt="Download Resume"/></a><p className={styles.bioButtonsText}>Resume</p></li>
                 </ul>
             </div>
            </div>
        )
